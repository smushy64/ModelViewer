#pragma once
#ifdef WINDOWS
#include "platform/win64/winpch.hpp"
...
public: // static
    static Microsoft::WRL::ComPtr<ID3D11DeviceContext>&    GetContext() { return m_context; }
    ...
    static Microsoft::WRL::ComPtr<ID3D11RenderTargetView>& GetBackbufferTargetView() { return m_backBufferTargetView; }

private: // static
    inline static Microsoft::WRL::ComPtr<ID3D11DeviceContext>    m_context;
    inline static Microsoft::WRL::ComPtr<IDXGISwapChain>         m_swapchain;
    inline static Microsoft::WRL::ComPtr<ID3D11Device>           m_device;
    inline static Microsoft::WRL::ComPtr<ID3D11RenderTargetView> m_backBufferTargetView;
...
private:
    ...
    Microsoft::WRL::ComPtr<ID3D11PixelShader> m_fshader = nullptr;
};
