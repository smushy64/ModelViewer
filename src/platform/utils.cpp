...
std::wstring Platform::Utils::CStringToWString( const char* cstring ) {
...
void Platform::Utils::EraseSubString( std::string& string, const std::string& subString ) {
...
std::wstring Platform::Utils::StringtoWString( std::string const& string ) {
